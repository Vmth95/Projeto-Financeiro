<?php
    ...
    class EmpresaDAO extends Conexao{
        ...
        public function ConsultarEmpresa(){
            ...
            $comando_sql = 'select id_empresa, nome_empresa, telefone_empresa, endereco_empresa from tb_empresa where id_usuario = ? order by nome_empresa';
